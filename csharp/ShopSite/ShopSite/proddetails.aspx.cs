...
namespace ShopSite
{
    public partial class proddetails : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(strcon);
            string str = null;
            str = "select count(*) from ctable3 where prodid='" + pid + "' and sessionid='" + Session["sessionid"].ToString() + "'"; SqlCommand com1 = new SqlCommand(str, con);
            con.Open();
            ...
            if (r == 0)
            {
                str = "insert into ctable3 values('" + pid + "','" + pname + "','" + pdescription + "','" + pprice + "','" + pimage + "','"
                + Session["sessionid"].ToString() + "'," + qty + ")";
